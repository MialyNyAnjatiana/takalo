...
<head>
    ...
    <title>Takalo | Demandes envoyées</title>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li class="active"><a href="/demandes-envoyees">Demandes envoyées</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="shoping__cart__table">
                            <table>
                                <thead>
                                    <tr>
                                        <th class="shoping__product">Vous demandez :</th>
                                        <th>Contre</th>
                                        <th>Receveur</th>
                                        <th>Etat</th>
                                    </tr>
                                    ...
                                    <?php foreach ($demandes as $demande): ?>
                                        <tr>
                                            ...
                                            <td class="shoping__cart__user">
                                                ...
                                                <span><?= htmlspecialchars($demande['nomReceveur']) ?></span>
                                            </td>
                                            <td class="shoping__cart__actions">
                                                <p><?= htmlspecialchars($demande['etat']) ?></p>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
